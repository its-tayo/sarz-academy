...
const Sessions: FC<Props> = ({ config }) => {
  return (
                ...
                <div className="md:flex md:flex-wrap md:items-center md:-mx-2.5">
                  <div className="md:w-1/2 lg:w-2/5 md:px-2.5">
                    ...
                    <p className="mt-7 mb-10 md:mb-0 sm:w-72 md:ml-0 sm:mx-auto sm:text-center md:text-left">
                      Break into the music industry through practical and
                ...
                <div className="light-bg hidden xl:flex xl:flex-col xl:w-1/2 xl:justify-center">
                  <div className="px-6 md:pl-14 md:pr-0 py-8 md:py-16">
                    ...
                    <p className="mt-7 mb-10 color-primary md:max-w-sm">
                      Please tell a bit about you so that we can personalise
          ...
          <section className="primary-bg">
            <div className="sz-container px-6 py-8 md:py-16">
              ...
              <p>
                ...
                songwriter, and actor, with a penchant for murdering beats.
                Having produced multiple hits such as Tesojue, Ponmile, and
                Problem, to name a few, he’s the perfect facilitator for the
                session on “Creative Approaches to Music Production” <br />{' '}
                <br />
                The biggest hits start with a tune in your head. You need to
                discover and nurture that sound. Creativity goes beyond the
                surface level and requires that an artist pushes themself to
                their boundaries. Through this session, the artists were taught
                to unlock their abilities, and some were surprised by what they
                found.
              </p>
              ...
              <p>
                ...
                production, then went deep into the nooks and crannies of
                musical sound engineering. It covered topics such as recording,
                editing, mixing, and mastering. In the class, the students were
                made to deal hands-on with equipment and practice what they were
                taught. They were then divided into groups of two, to use the
                skills they had learnt, to produce beautiful melodies.
              </p>
              ...
              <p>
                The Kako bii Chiken crooner then rounded up the class with the
                group project presentation, thus ending the sessions with a
                bang. All the students were truly imparted
              </p>
            </div>
          </section>
        </div>
...
export async function getStaticProps(): Promise<any> {
  try {
    const {
      data: { config },
    } = await prismicClient.getByUID('config', 'config')
